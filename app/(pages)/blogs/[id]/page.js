      ...
      <div className="something">
            ...
            <div className="mx-auto max-w-screen-xl px-4 2xl:px-0">
                ...
                <div className="group overflow-hidden my-8 xl:mb-16 xl:mt-12">
                    <img className="hidden w-full max-h-100 rounded object-cover group-hover:scale-110 group-active:scale-110 duration-300 ease-in-out dark:block" src={blog.image} alt="blog image" />
                </div>
