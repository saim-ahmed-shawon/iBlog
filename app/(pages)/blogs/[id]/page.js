      ...
      <div className="something">
            ...
            <div className="mx-auto max-w-screen-xl px-4 2xl:px-0">
                ...
                <div className="group overflow-hidden my-8 xl:mb-16 xl:mt-12">
                    <Image className="w-full max-h-100 rounded object-cover group-hover:scale-110 group-active:scale-110 duration-300 ease-in-out dark:block" src={blog.image} width={720} height={720} alt="blog image" />
                </div>
