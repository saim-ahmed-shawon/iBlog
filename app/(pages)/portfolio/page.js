...
<div className="cards grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4  gap-4">
  ...
  <div className="card group h-100 border-5 rounded border-slate-900 dark:border-white overflow-hidden relative">
    ...
    <h2 className="absolute text-4xl text-white font-bold group-hover:text-slate-500 right-10 bottom-10 duration-300 ease-out">Earth</h2>
  </div>
  </Link>
  ...
  <div className="card group h-100 border-5 rounded border-slate-900 dark:border-white overflow-hidden relative">
    ...
    <h2 className="absolute text-4xl text-white font-bold group-hover:text-slate-500 right-10 bottom-10 duration-300 ease-out">Moon</h2>
  </div>
  </Link>
  ...
  <div className="card group h-100 border-5 rounded border-slate-900 dark:border-white overflow-hidden relative">
    ...
    <h2 className="absolute text-4xl text-white font-bold group-hover:text-slate-500 right-10 bottom-10 duration-300 ease-out">Mars</h2>
  </div>
  </Link>
</div>
</div>
